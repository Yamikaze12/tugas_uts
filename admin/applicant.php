    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../log.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
											...
											if(isset($_POST["schedule"])){
													...
													$intview = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($intview){
																...
																$mail->SMTPAuth = true;
																$mail->Username = 'azririandy@gmail.com';						/////////////////////// ISI DENGAN ALAMAT GMAIL KALIAN
																$mail->Password = 'password';						/////////////////////// ISI DENGAN PASSWORD GMAIL NYA
